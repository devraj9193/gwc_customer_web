...
class DetoxHealingModel{
  ...
  String? isTrackerSubmitted;
  String? note;
  Map<String, List<ChildMealPlanDetailsModel1>>? data;

  DetoxHealingModel({this.programDay, this.comment, this.note, this.data, this.isDayCompleted,this.isTrackerSubmitted,});
  ...
  Map<String, dynamic> toMap() {
    final Map<String, dynamic> data1 = new Map<String, dynamic>();
      ...
      data1['is_tracker_submitted'] = this.isTrackerSubmitted;
      print(data);
    if (this.data != null) {
  ...
  DetoxHealingModel.fromMap(Map<String, dynamic> json) {
    ...
    isTrackerSubmitted = json['is_tracker_submitted'].toString();
    print(json['data']);
