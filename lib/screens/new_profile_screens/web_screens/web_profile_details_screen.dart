...
import '../../../model/profile_model/user_profile/send_user_model.dart';
...
class WebProfileDetailsScreen extends StatefulWidget {
  const WebProfileDetailsScreen({Key? key}) : super(key: key);

  @override
  State<WebProfileDetailsScreen> createState() =>
      _WebProfileDetailsScreenState();
}

class _WebProfileDetailsScreenState extends State<WebProfileDetailsScreen> {
                  ...
                  : Align(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () async {
                              if (int.parse(ageController.text) < 10 ||
                      ...
                      Column(
                        children: [
                          Row(
                            children: [
                              Expanded(
                                child: profileTile("First Name: ",
                                    subData?.fname ?? "Gut-Wellness Club",
                                    controller: fnameController),
                              ),
                              Expanded(
                                child: profileTile("Last Name: ",
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: profileTile("Age: ", subData?.age ?? '',
                          ...
                          Row(
                            children: [
                              Expanded(
                                child:
                                    profileTile("Email: ", subData?.email ?? '',controller: emailController),
                              ),
                              Expanded(
                                child: profileTile(
                                    "Mobile Number: ", subData?.phone ?? '',controller: mobileController),
                              ),
                            ],
                          ),
                          Row(
  ...
  profileTile(String title, String subTitle,
    ...
    return Padding(
      padding: EdgeInsets.only(top: 1.h, bottom: 2.h, left: 3.w),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        // mainAxisSize: MainAxisSize.min,
        children: [
