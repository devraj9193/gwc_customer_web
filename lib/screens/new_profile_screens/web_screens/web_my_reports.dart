...
import '../reports_screens/get_user_reports.dart';

class WebMyReports extends StatefulWidget {
  const WebMyReports({Key? key}) : super(key: key);

  @override
  State<WebMyReports> createState() => _WebMyReportsState();
}

class _WebMyReportsState extends State<WebMyReports> {
  final List myTabs = [
    {
      "text": 'User Uploaded',
